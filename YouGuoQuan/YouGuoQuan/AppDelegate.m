...
- (void)applicationWillEnterForeground:(UIApplication *)application {
    ...
    [UserDefaultsTool autoLogin];// 处理账号冻结
    
    [UnreadMsgTool getTotalUnreadMessageNumber];
...
- (void)userAccountDidLoginFromOtherDevice {
    [[EMClient sharedClient] logout:NO completion:^(EMError *aError) {
        if (!aError) {
            ...
            [AlertViewTool showAlertViewWithTitle:@"警告" Message:@"你的账号已在其他地方登录" buttonTitle:@"确定" sureBlock:^{
