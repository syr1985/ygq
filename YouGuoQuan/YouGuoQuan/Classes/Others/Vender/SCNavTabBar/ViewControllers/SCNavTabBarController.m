...
- (void)viewInit {
    ...
    } else if (_navType == NavType_Order) {
        viewH = SCREEN_HEIGHT - viewY - STATUS_BAR_HEIGHT - 44;
    }
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"NavItemSelectedNotification"
                                                        object:nil
