...
- (void)initSubViews
{
    ...
    UIButton *_sendBtn = [UIButton buttonWithType:UIButtonTypeSystem];
    _sendBtn.frame = CGRectMake(self.frame.size.width - 80, CGRectGetMaxY(_scrollView.frame) - 40, 60, 40);
    //    [_sendBtn setTitle:@"发送" forState:UIControlStateNormal];
    //    [_sendBtn setTitleColor:[UIColor colorWithRed:1 green:200/255.0 blue:100/255.0 alpha:1] forState:UIControlStateNormal];
    [_sendBtn setBackgroundImage:ZMLKeyboardBundleImage(@"btn_comment_expression_send") forState:UIControlStateNormal];
