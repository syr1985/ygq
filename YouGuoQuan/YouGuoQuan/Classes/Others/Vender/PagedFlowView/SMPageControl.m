...
- (void)_renderPages:(CGContextRef)context rect:(CGRect)rect
{
    ...
    for (NSInteger i = 0; i < _numberOfPages; i++) {
        ...
        if (image) {
            ...
            indicatorRect = CGRectMake(xOffset, yOffset, image.size.width, image.size.height);
        ...
        xOffset += image.size.width + _indicatorMargin;
    }
...
- (CGSize)sizeForNumberOfPages:(NSInteger)pageCount
{
    ...
    CGFloat indicatorSpace = (pageCount + 1) * 10;//pageCount * _measuredIndicatorWidth;
