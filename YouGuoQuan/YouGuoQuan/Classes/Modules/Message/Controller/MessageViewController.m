...
- (void)updateUnreadMsgNumber {
    if ([LoginData sharedLoginData].userId) {
        ...
        NSInteger unreadMsgCount = item.badgeValue ? item.badgeValue.integerValue : 0;
        NSString *badgeValue = [NSString stringWithFormat:@"%zd",++unreadMsgCount];
...
- (void)settingBadgeValue {
    ...
    id rootVC = self.tabBarController;
