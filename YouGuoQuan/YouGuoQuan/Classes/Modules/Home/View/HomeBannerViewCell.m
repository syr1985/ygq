...
- (void)awakeFromNib {
    ...
    CGFloat heght = (WIDTH - 54) * 198 / 322 + 28;
    ...
    pageFlowView.minimumPageScale = 0.94;
    pageFlowView.orientation = NewPagedFlowViewOrientationHorizontal;
    pageFlowView.isOpenAutoScroll = YES;
    
    CGRect pageControlRect = CGRectMake(0, pageFlowView.frame.size.height - 15, WIDTH, 3);
    SMPageControl *pageControl = [[SMPageControl alloc] initWithFrame:pageControlRect];
    pageControl.indicatorMargin = 5;
    pageControl.pageIndicatorImage = [UIImage imageFromContextWithColor:TextViewPlaceHolderColor
                                                                   size:CGSizeMake(10,3)];
    pageControl.currentPageIndicatorImage = [UIImage imageFromContextWithColor:NavColor
                                                                          size:CGSizeMake(20, 3)];
...
- (CGSize)sizeForPageInFlowView:(NewPagedFlowView *)flowView {
    return CGSizeMake(WIDTH - 54, (WIDTH - 54) * 198 / 322);
}
...
- (UIView *)flowView:(NewPagedFlowView *)flowView cellForPageAtIndex:(NSInteger)index {
    ...
    if (!bannerView) {
        bannerView = [[IndexBannerSubiew alloc] initWithFrame:CGRectMake(0, 0, WIDTH - 54, (WIDTH - 54) * 198 / 322)];
    }
