...
NSString *const kNotification_OfficiallyCertifiedSuccess = @"kNotificationOfficiallyCertifiedSuccess";
                                                 ...
                                                 verifiCode:_authCode
                                                  ...
                                                  auditType:_certifiedType success:^{
                                                      ...
                                                      if (weakself.userBaseInfoModel) {
                                                          ...
                                                          [[NSNotificationCenter defaultCenter] postNotificationName:kNotification_OfficiallyCertifiedSuccess
                                                                                                              object:nil
                                                                                                            userInfo:@{@"type":_certifiedType}];
                                                      }
