...
@property (weak, nonatomic) IBOutlet UILabel *orderDidDateLabel;
...
- (void)setOrderModel:(MyOrderModel *)orderModel {
    ...
    self.orderDidDateLabel.text = [self.dateFormatter stringFromDate:date];
}

- (IBAction)dateingSuccessButtonClicked:(id)sender {
    __weak typeof(self) weakself = self;
    [AlertViewTool showAlertViewWithTitle:nil Message:@"您是否已完成赴约？" cancelTitle:@"取消" sureTitle:@"确定" sureBlock:^{
