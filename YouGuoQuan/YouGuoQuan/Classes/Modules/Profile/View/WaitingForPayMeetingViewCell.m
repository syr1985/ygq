...
@interface WaitingForPayMeetingViewCell ()
...
@implementation WaitingForPayMeetingViewCell
...
- (IBAction)goonPayButtonClicked:(id)sender {
    if (_goonPayBolck) {
        _goonPayBolck(_orderModel.orderNo, _orderModel.price, _orderModel.goodsId, _orderModel.buyerEmail, _orderModel.buyerPhone);
    }
}
