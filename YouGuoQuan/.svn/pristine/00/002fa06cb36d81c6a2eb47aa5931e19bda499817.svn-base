...
- (void) setupFunctionView {
    NSArray *normalImages = @[@"消息-语音", @"消息-位置", @"消息-红包", @"消息-表情"];// @"消息-发图", @"消息-阅后即焚", @"消息-约见",
    NSArray *highlightedImages = @[@"消息-语音-点击", @"消息-位置-点击", @"消息-红包-点击", @"消息-表情-点击"];//, @"消息-发图-点击", @"消息-阅后即焚-点击" @"消息-约见-点击",
