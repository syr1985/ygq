...
- (void)setPriceText:(NSString *)priceText {
    ...
    self.productPriceTextField.text = priceText;
}
...
- (void)textFieldDidBeginEditing:(UITextField *)textField {
    if (textField == _productPriceTextField) {
        ...
        if (_selectProductPriceBlock) {
            _selectProductPriceBlock();
        }
    }
}
...
- (void)textFieldDidEndEditing:(UITextField *)textField {
    if (self.setProductInfo) {
        self.setProductInfo(_productNameTextField.text, _productIntroTextView.text);
    }
}
