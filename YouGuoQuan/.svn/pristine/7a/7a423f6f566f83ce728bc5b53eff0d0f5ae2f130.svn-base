...
+ (void)saveLoginData {
    NSDictionary *userInfoDict = @{@"id"                : [LoginData sharedLoginData].userId,
                                   ...
                                   @"havePublishWX"     : @([LoginData sharedLoginData].havePublishWX),
                                   @"publishWX"         : [LoginData sharedLoginData].publishWX,
                                   @"publishWXPrice"    : [LoginData sharedLoginData].publishWXPrice,
