...
{
    NSString *emoji = [sender.emotion.code emoji];
    [[NSNotificationCenter defaultCenter] postNotificationName:MiddleSizeFacePanelfacePickedNotification object:emoji];
}
