...
@property (nonatomic,   copy) void (^longPressBlock)(id<IMessageModel> model, EaseBubbleView *bubbleView);

//@property (nonatomic,   copy) void (^copyMessageBlock)(id<IMessageModel> model);

//@property (nonatomic,   copy) void (^deleteMessageBlock)(id<IMessageModel> model);
/*
 *  头像尺寸大小
 */
