...
- (UIButton *)albumBtn {
    if (!_albumBtn) {
        ...
        [_albumBtn setTitleColor:NavTabBarColor forState:UIControlStateNormal];
...
- (UIButton *)riginBtn {
    if (!_originBtn) {
        ...
        [_originBtn setTitleColor:NavTabBarColor forState:UIControlStateNormal];
...
- (UIButton *)sendBtn {
    if (!_sendBtn) {
        ...
        [_sendBtn setTitleColor:NavTabBarColor forState:UIControlStateNormal];
...
- (UILabel *)selectCountLabel {
    if (!_selectCountLabel) {
        ...
        _selectCountLabel.layer.backgroundColor = NavTabBarColor.CGColor;
