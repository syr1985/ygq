...
- (void)configCropView {
    ...
    if (_tzImagePickerVc.allowCrop) {
        ...
        [UIImageCropManager overlayClippingWithView:_cropBgView
...
- (void)okButtonClick {
    ...
    if (_tzImagePickerVc.allowCrop) { // 裁剪状态
        ...
        UIImage *cropedImage = [UIImageCropManager cropImageView:cell.imageView
                                                          toRect:_tzImagePickerVc.cropRect
                                                       zoomScale:cell.scrollView.zoomScale
                                                   containerView:self.view];
    ...
    } else if (self.okButtonClickBlock) {
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    TZImagePickerController *_tzImagePickerVc = (TZImagePickerController *)self.navigationController;
    if (_tzImagePickerVc.allowCrop) {
        cell.cropRectHeight = _tzImagePickerVc.cropRect.size.height;
    }
