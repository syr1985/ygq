...
- (void)configBottomToolBar {
    ...
    [_okButton setTitleColor:[UIColor colorWithRed:(245/255.0) green:147/255.0 blue:35/255.0 alpha:1] forState:UIControlStateNormal];//tzImagePickerVc.oKButtonTitleColorNormal
    [_okButton setTitleColor:[UIColor colorWithRed:(245/255.0) green:147/255.0 blue:35/255.0 alpha:1] forState:UIControlStateDisabled];//tzImagePickerVc.oKButtonTitleColorDisabled
...
//    _numberImageView.backgroundColor = [UIColor clearColor];
    ...
    _numberLable.frame = CGRectMake(self.view.tz_width - 56 - 24, 15, 20, 20);//_numberImageView.frame;
    ...
    _numberLable.backgroundColor = [UIColor colorWithRed:(245/255.0) green:147/255.0 blue:35/255.0 alpha:1];// [UIColor clearColor];
    _numberLable.layer.cornerRadius = 10;
...
- (void)previewButtonClick {
    ...
    //photoPreviewVc.allowEditPicture = imagePickerVc.allowEditPicture;
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (model.type == TZAssetModelMediaTypeVideo) {
        ...
        photoPreviewVc.models = [NSMutableArray arrayWithArray:@[model]]; // @[model];//_models;
        [self pushPhotoPrevireViewController:photoPreviewVc];
    }
}
