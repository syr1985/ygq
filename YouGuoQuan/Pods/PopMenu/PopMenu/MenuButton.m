...
- (instancetype)initWithFrame:(CGRect)frame menuItem:(MenuItem *)menuItem {
    ...
    if (self) {
        ...
        self.titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(self.iconImageView.bounds), CGRectGetWidth(self.bounds), 21)];
        self.titleLabel.textColor = [UIColor colorWithRed:(53/255.0) green:(32/255.0) blue:(7/255.0)  alpha:1];
        self.titleLabel.backgroundColor = [UIColor clearColor];
        self.titleLabel.font = [UIFont fontWithName:@"STHeiti" size:10];//[UIFont systemFontOfSize:14];
